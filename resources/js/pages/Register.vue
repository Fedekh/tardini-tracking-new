            ...
            <div class="p-8 bg-white rounded shadow-xl">
                <form>
                    <div class="mt-4">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-100 rounded" id="name" type="text" name="name"
                            placeholder="nome" v-model="name" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-100 rounded" id="lastname" type="text"
                            name="lastname" placeholder="cognome" v-model="lastname" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <span v-if="submitted && !email" class="text-red-600">Inserisci un indirizzo email
                            valido.</span>
                    ...
                    <div class="mt-4">
                        ...
                        <span v-if="submitted && !password" class="text-red-600">Inserisci una password valida.</span>

                    </div>
                    <div class="mt-4">
                        <label class="block text-sm text-gray-00" for="branch" value="branch"></label>
                        <input class="w-full px-2 py-2 text-gray-700 bg-gray-100 rounded" id="branch" type="text"
                            placeholder="filiale" name="branch" v-model="branch" required autocomplete="current-branch" />
